...
init(){this.element.style.position="relative";this.element.style.width="100%";this.setAllElements(this.content,(i)=>{i.tmp={};i.tmp.display=i.style.display;this.setStyle(i,"display:none;position:absolute;top:0;left:0;bottom:unset;transform:none;width:100%;height:100vh;pointer-events:none")})
...
document.addEventListener("DOMContentLoaded",()=>{for(let i of document.querySelectorAll(".scroll-page")){new ScrollPage(i)}})